...
<p align="center">
  <strong>Undergraduate Researcher in Software Engineering</strong><br />
...
**ML and acceleration** — `PyTorch` · `CUDA`<br />
**Robotics and systems** — `ROS 2` · `Linux` · `Git`<br />
